...
@endif
        ...
        <form action="{{ route('form.store') }}" method="POST">
            ...
            <!-- NAME -->
            <div class="mb-4">
                <label for="name" class="fw-bold mb-1">Your Name</label>
                <input type="text"
                       id="name"
                       name="name"
            ...
            <h6 class="fw-bold mb-3 mt-2 text-dark">
                အသုံးပြုသူ၏ ဝန်ခံကတိများနှင့် အသိအမှတ်ပြုမှုများ
            </h6>
            ...
            <div class="border rounded bg-white p-3 shadow-sm terms-box">
                ...
                <p class="lh-lg mb-2">
                    လျှောက်ထားသူရွေးချယ်ထားသောSamsung မိုဘိုင်းလ်စက်ပစ္စည်းအား Samsung Knox Guard ဝန်ဆောင်မှု ကို ကြိုတင်ထည့်သွင်းပြီး ရောင်းချပါသည်။ ဤဝန်ဆောင်မှုသည် Rent 2 Own MM အစီအစဉ်၏ မရှိမဖြစ် အစိတ်အပိုင်းတစ်ခုဖြစ်ပြီး လျှောက်ထားသူ၏ ငွေပေးချေမှုအခြေအနေပေါ် မူတည်၍ စက်ပစ္စည်းကို စီမံခန့်ခွဲရန် ကုမ္ပဏီအား လုပ်ပိုင်ခွင့်ပေးကြောင်း လျှောက်ထားသူမှ သဘောတူပါသည်။ 
